...
_laptopFile_2 = ["prison_laptop_file_2",  format[localize "STR_ADL_ATOL_ACE_SHOW_FILE","hastubiro"], "", {[player, _target] call ADL_MNU_INTEL_EMAIL;}, {true}] call ace_interact_menu_fnc_createAction;
...
_laptopVideo_1 = ["prison_laptop_video_1", format[localize "STR_ADL_ATOL_ACE_SHOW_VIDEO","us guy"], "", {[prison_laptop, "GA_MIS_ATOL\video\intro_video.ogg", "snd_video_intro"] spawn ADL_VIDEO_SHOW_SRV}, {true}] call ace_interact_menu_fnc_createAction;
