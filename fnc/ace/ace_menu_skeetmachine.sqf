...
_actionThrowSkeet = ["skeet_shoot_single","Neue Disk","", {[[[_target],"fnc\srv\spawnSkeet.sqf"],"BIS_fnc_execVM",false,false] call BIS_fnc_MP;}, {true}, {},[],[0,0,0],6] call ace_interact_menu_fnc_createAction;
["SkeetMachine", 0, ["ACE_MainActions"], _actionThrowSkeet] call ace_interact_menu_fnc_addActionToClass;

_actionThrowSkeet10 = ["skeet_shoot_10","10 Disk's","", {[[[_target, false, 10],"fnc\srv\spawnSkeet.sqf"],"BIS_fnc_execVM",false,false] call BIS_fnc_MP;}, {true}, {},[],[0,0,0],6] call ace_interact_menu_fnc_createAction;
["SkeetMachine", 0, ["ACE_MainActions"], _actionThrowSkeet10] call ace_interact_menu_fnc_addActionToClass;

_actionAutoSkeet = ["skeet_shoot_auto","Automatisch","", {[[[_target, true, 1],"fnc\srv\spawnSkeet.sqf"],"BIS_fnc_execVM",false,false] call BIS_fnc_MP;}, {true}, {},[],[0,0,0],6] call ace_interact_menu_fnc_createAction;
