...
[tonne, 0, ["ACE_MainActions"], _dropAction] call ace_interact_menu_fnc_addActionToObject;
 ...
 /*
[(typeOf tonne), 0, [], _mainAction] call ace_interact_menu_fnc_addActionToClass;
[tonne, 0, ["ACE_MainActions"], _tstAction] call ace_interact_menu_fnc_addActionToObject; 
tonne setVariable ["ace_dragging_canDrag", true];  
tonne setVariable ["ace_dragging_dragPosition", [0,0,0]];  
tonne setVariable ["ace_dragging_dragDirection", 20]; 
//tonne setMass 0.1; tonne addMagazineCargoGlobal ["FakeMagazine", 1];
[player, tonne] call ace_dragging_fnc_startDrag;
*/